...
public class Exercicio15 {
	...
	public static void main(String[] args) {
		...
		if (idade >= 65 || tempoEmpresa >= 30 || (idade >= 60 && tempoEmpresa >= 25)) {
			System.out.println();
			System.out.println(codigoFuncionario + ", idade: "+ idade + ", tempo de firma: " + tempoEmpresa + ", pode aposentar, requerer aposentadoria?" );
		} else {
			System.out.println();
			System.out.println(codigoFuncionario + ", idade: "+ idade + ", tempo de firma: " + tempoEmpresa + ", não pode aposenta ainda" );
		}
